...
full_data = pd.read_csv("/home/andrea/Desktop/data_mining/covid19_tweets_without_errors.txt", sep=",")
...
for tweet in data['text']:
    ...
    for j in range(len(set_of_words)):
        word = set_of_words[j-length_list]
        # print(i, " ", word)
        if "@" in word:
